...
const WorkspacePreview: React.FC = () => {
    const { state } = useContext(ParallaxEditorContext);
    ...
    return (
        <Paper
            ...
            sx={{
                ...
                position: 'relative',
                overflow: 'hidden', // Clip elements outside viewport
                border: '1px solid #ccc',
                transformOrigin: 'center center', // For potential zooming of the workspace itself
            }}
        >
            {/* Viewport Center Guide (optional) */}
            ...
            {/* Layers - sorted by zIndex for correct editor stacking */}
            {[...layers].sort((a, b) => a.zIndex - b.zIndex).map(layer => {
                ...
                return (
                    <Box
                        ...
                        sx={{
                            position: 'absolute',
                            top: 0, left: 0, right: 0, bottom: 0, // Full layer size
                        ...
                        {layer.elements.map(element => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    transform: `translate(-50%, -50%) scale(${cameraZoom}) rotate(${element.rotation}deg)`, // Element's own transform
